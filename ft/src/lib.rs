...
pub struct Contract {
    ...
    token_factory_account: ValidAccountId,
    burn_token_account: ValidAccountId
}
...
impl Contract {
    ...
    pub fn new(
        ...
        assert!(
            env::predecessor_account_id() == token_factory_account.to_string(),
    ...
    pub fn burn_token( 
        ...
        assert!(
            env::predecessor_account_id() == self.burn_token_account.to_string(),
